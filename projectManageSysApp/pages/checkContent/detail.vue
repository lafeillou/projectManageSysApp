		...
		<scroll-view scroll-y>
			...
			<view class="photo-content-wrap">
				...
				<div class="history-problem-wrap">
					...
					<view class="histroy-problem-item" v-for="(item,index) in problemList" :key="item.id" style="margin-bottom:20upx;">
						...
						<view style="padding:20upx;">
							<image style="display:inline-block;width:80upx;height:80upx;margin-right:10px;" :src="item.images.split(',')[0]" mode="aspectFill"></image>
							<image style="display:inline-block;width:80upx;height:80upx;margin-right:10px;" :src="item.images.split(',')[1]" mode="aspectFill"></image>
							<image style="display:inline-block;width:80upx;height:80upx;margin-right:10px;" :src="item.images.split(',')[2]" mode="aspectFill"></image>
							<image style="display:inline-block;width:80upx;height:80upx;margin-right:10px;" :src="item.images.split(',')[3]" mode="aspectFill"></image>
						</view>
					</view>
				</div>
